...
import adminBg from '../../../static/adminbackground.png'
...
class Login extends Component {
  ...
  login(data) {
    ...
    .then(res => {
      if(res.data.data === 0) {
        ...
        message.success('登录成功,即将跳转到管理后台!', 1.5)
        setTimeout(() => {
  ...
  render() {
    ...
    if(this.state.redirect) 
      ...
      return (
      <div className="wrapper" style={{backgroundImage: `url(${adminBg})`}}>
          <Link to="/">
          ...
          <div className="card">
            <div className="sign-wrapper">
              <span className="signin-btn ">后台管理登录</span>
            </div>
