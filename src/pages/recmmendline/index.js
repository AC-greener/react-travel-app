  ...
  render () {
    return (
        <Layout className="layout">
          ...
          <Carousel  autoplay>
            <div style={{ width: '100%'}}>
              <img src='/static/bg-recolinejpg.jpg' alt='图片未加载'></img>
            </div>
          </Carousel>
            ...
            <Row style={{ padding: '0 250px'}} justify="space-around" gutter={{ xs: 8, sm: 16, md: 24, lg: 32 }}>
                ...
                <div className='card-wrapper'>
                  <Link to={'/recline/detail/1'}>
                    <Card className='rec-line-card' style={{width: 310, height: '370px'}}
                      hoverable
                      cover={<img alt="example"  srcSet  src='/static/recoline1.jpg' />}
                    >
              ...
              <Col className="gutter-row" span={8}>
                ...
                <Link to='/recline/detail/2'>
                  <Card className='rec-line-card' style={{width: 310, height: '370px'}}
                    hoverable
                    cover={<img alt="example"  srcSet  src='/static/recoline2.jpg' />}
                  >
              ...
              <Col className="gutter-row" span={8}>
                <div className='card-wrapper'>
                  <Link to='/recline/detail/3'>
                    <Card className='rec-line-card' style={{width: 310, height: '370px'}}
                      hoverable
                      cover={<img alt="example"  srcSet  src='/static/recoline3.jpg' />}
                    >
                      <div className='card-day'>7<span>天</span></div>
            ...
            <Row style={{ padding: '0 250px'}} justify="space-around" gutter={{ xs: 8, sm: 16, md: 24, lg: 32 }}>
              <Col className="gutter-row" span={8}>
                ...
                <Link to='/recline/detail/4'>
                  <Card className='rec-line-card' style={{width: 310, height: '370px'}}
                    hoverable
                    cover={<img alt="example"  srcSet  src='/static/recoline4.jpg' />}
                  >
              ...
              <Col className="gutter-row" span={8}>
                ...
                <Link to='/recline/detail/5'>
                  <Card className='rec-line-card' style={{width: 310, height: '370px'}}
                    hoverable
                    cover={<img alt="example"  srcSet  src='/static/recoline5.jpg' />}
                  >
                    <div className='card-day'>7<span>天</span></div>
              ...
              <Col className="gutter-row" span={8}>
                ...
                <Link to='/recline/detail/6'>
                  <Card className='rec-line-card' style={{width: 310, height: '370px'}}
                    hoverable
                    cover={<img alt="example"  srcSet  src='/static/recoline6.jpg' />}
                  >
                    <div className='card-day'>7<span>天</span></div>
